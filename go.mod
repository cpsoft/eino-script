...
require (
	...
	github.com/cloudwego/eino-ext/callbacks/apmplus v0.0.0-20250417123744-154d7ca4d3cd
	github.com/cloudwego/eino-ext/components/model/ollama v0.0.0-20250417123744-154d7ca4d3cd
	github.com/cloudwego/eino-ext/components/model/qwen v0.0.0-20250417123744-154d7ca4d3cd
